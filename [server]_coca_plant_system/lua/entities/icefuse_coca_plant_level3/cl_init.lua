...
File Path:   addons/[server]_coca_plant_system/lua/entities/icefuse_coca_plant_level3/cl_init.lua
...
function ENT:DrawTranslucent()
	...
	//Time
	local time = self:GetCokaPlantTimer()
...
//=======================================================================//
	...
	cam.Start3D2D(pos, angle, 0.15 / SCALE)
		...
		surface.SetDrawColor(95, 127, 63, 255 * opacity)
		...
		draw.SimpleText("Coka Plant Timer" or actualtime, 'ph_TrebuchetC',
